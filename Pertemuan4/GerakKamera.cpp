...
void display()
{
    glClear(
        ...
        GL_DEPTH_BUFFER_BIT); // clear the depth buffer (depth)
...
//-------------------------------------------------------------------------
int main(int argc, char** argv) // Tambahkan parameter argc dan argv
{
    glutInit(&argc, argv); // WAJIB: Inisialisasi GLUT terlebih dahulu
